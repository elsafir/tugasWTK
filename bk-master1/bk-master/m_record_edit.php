<?php
  ...
  if (isset($_COOKIE["record_edit"]["tanggal"])) {
    $tgl = $_COOKIE["record_edit"]["tanggal"]["tgl"];
    $bln = $_COOKIE["record_edit"]["tanggal"]["bln"];
    $thn = $_COOKIE["record_edit"]["tanggal"]["thn"];
  }
  ...
  if (isset($_COOKIE["record_edit"]["layanan"])) {
	$layanan = $_COOKIE["record_edit"]["layanan"];
    switch($layanan) {
...
<html lang="en">
  <head>
    ...
    <title>Edit Record | Record | Pengelolaan Arsip Bimbingan Konseling</title>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <?php
                ...
                $info = "Silahkan cari dan pilih terlebih dahulu <b>Siswa yang bersangkutan</b>, setelah itu silahkan Edit <b>Rincian kegiatan</b>";
          ...
          <div class="col-md-5">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form class="" action="m_record_edit_p.php" method="post">
                  <div class="input-group input-group-sm">
                    <input type="text" name="search" class="form-control" placeholder="Cari dengan NIS atau Nama Siswa"
                      value="<?php if (isset($_COOKIE["record_edit"]["search"])) { echo $_COOKIE["record_edit"]["search"]; } ?>">
                ...
                <br>
                <?php
    							if (isset($_COOKIE["record_edit"]["search"])) {
                    $search = filter_sql($link, $_COOKIE["record_edit"]["search"]);
    									...
    									while ($data_siswa = mysqli_fetch_assoc($result_siswa)) {
    										echo "<tr>";
    											...
    											echo "<td class='text-center'>";
    												echo "<form action='m_record_edit_p.php' method='post'>";
          ...
          <div class="col-md-7">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <form action="m_record_edit_p.php" method="post" id="form-record" class="form-horizontal" >
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="tempat" type="text" class="form-control" placeholder="Tempat Kegiatan" value="<?php if (isset($_COOKIE["record_edit"]["tempat"])) { echo $_COOKIE["record_edit"]["tempat"]; } ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="uraian" class="col-sm-2 control-label" >Uraian Kegiatan</label>
                    <div class="col-sm-10">
      								<textarea name="uraian" rows="3" class="form-control" placeholder="Uraian Kegiatan"><?php if (isset($_COOKIE["record_edit"]["uraian"])) { echo $_COOKIE["record_edit"]["uraian"]; } ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="uraian" class="col-sm-2 control-label" >Keterangan</label>
                    <div class="col-sm-10">
                      <textarea name="keterangan" rows="1" class="form-control" placeholder="Keterangan Kegiatan"><?php if (isset($_COOKIE["record_edit"]["keterangan"])) { echo $_COOKIE["record_edit"]["keterangan"]; } ?></textarea>
                    </div>
                  </div>
                </form>
        ...
        <div class="row">
            <div class="col-md-12" style="text-align: right;">
              ...
              <button type="submit" name="submit" value="SAVE" form="form-record" class="btn btn-lg btn-primary"> <span class="glyphicon glyphicon-floppy-disk"></span> Update</button>
            </div>
        </div>
